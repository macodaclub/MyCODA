...
fun Application.configureOntology(): Triple<OWLOntology, OWLOntology, OWLReasoner> {
    val manager = OWLManager.createOWLOntologyManager()
    val mycodaOntology = manager.loadOntologyFromOntologyDocument(this.javaClass.classLoader!!.getResourceAsStream("static/MaCODA.owl")!!)
